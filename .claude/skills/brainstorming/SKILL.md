...
5. **Write design doc** — save to `~/Obsidian/claude-workspace/Plans/<2-4-word-kebab>.md` and commit
6. **Spec self-review** — quick inline check for placeholders, contradictions, ambiguity, scope (see below)
7. **User reviews written spec** — ask user to review the spec file before proceeding
8. **Save the plan** — write the design as `~/Obsidian/claude-workspace/Plans/<2-4-word-kebab>.md` and stop. The user reviews and triggers execution.
